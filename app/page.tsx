            ...
            <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-12 items-center">
               <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                     ...
                     {/* </Link> */}
                     <Link href="/dashboard">
                        <button className="border border-white/20 flex items-center gap-2 bg-white text-black  px-6 py-3 rounded-full font-bold hover:bg-white/70 transition-colors">
